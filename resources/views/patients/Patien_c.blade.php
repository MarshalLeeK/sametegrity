        ...
        <div class="container bg-light">
            <main>
                <div class="text-center" >
                    <h1  class=""><span class="w-100">Registro de Pacientes</span></h1>
                    <hr class="my-1">
                </div>
                <div class="row g-12">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="row mt-g-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="dni" id="dni" placeholder="Número Documento" value="" required="" 
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-select" name="gender" id="gender" aria-label="" required
                                oninvalid="this.setCustomValidity('Por favor ingrese un tipo de documento de documento valido')" 
                                oninput="setCustomValidity('')">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="number" class="form-control" name="age" id="age" placeholder="Edad" disabled>
                            </div>

                            <div class="col-sm-3">
                                <label for="borncountry" class="form-label">Pais de nacimiento</label>
                                @if ( auth()->check() )       
                                    <select class="form-select" name="borncountry" id="borncountry" aria-label="" required
                                    oninvalid="this.setCustomValidity('Por favor ingrese un pais valido')" 
                                    oninput="setCustomValidity('')"
                                    value="Colombia">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-select" name="borncity" id="borncity" aria-label="" required
                                oninvalid="this.setCustomValidity('Por favor ingrese un tipo de documento de documento valido')" 
                                oninput="setCustomValidity('')">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-select" name="civilsate" id="civilsate" aria-label="" required
                                oninvalid="this.setCustomValidity('Por favor ingrese un tipo de documento de documento valido')" 
                                oninput="setCustomValidity('')">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-select" name="academiclevel" id="academiclevel" aria-label="" required
                                oninvalid="this.setCustomValidity('Por favor ingrese un tipo de documento de documento valido')" 
                                oninput="setCustomValidity('')">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-select" name="job" id="job" aria-label="" required
                                oninvalid="this.setCustomValidity('Por favor ingrese un tipo de documento de documento valido')" 
                                oninput="setCustomValidity('')">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-select" name="livecontry" id="livecontry" aria-label="" required
                                oninvalid="this.setCustomValidity('Por favor ingrese un tipo de documento de documento valido')" 
                                oninput="setCustomValidity('')">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-select" name="livestate" id="livestate" aria-label="" required
                                oninvalid="this.setCustomValidity('Por favor ingrese un tipo de documento de documento valido')" 
                                oninput="setCustomValidity('')">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-select" name="livecity" id="livecity" aria-label="" required
                                oninvalid="this.setCustomValidity('Por favor ingrese un tipo de documento de documento valido')" 
                                oninput="setCustomValidity('')">
                                    <option selected value="">Seleccione ciudad</option>
                                    <option value='Bello'>Bello</option>
                                    ...
                                    <div class="tab-pane fade show active p-2" id="nav-medicalbond" role="tabpanel" aria-labelledby="nav-medicalbond-tab">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <label for="eps" class="form-label col-sm-9 col-md-8"> Entidad </label>
                                                    <div class="form-check col-sm-3 col-md-4 d-inline-flex flex-row-reverse" id="check">
                                                        ...
                                                        <input class="form-check-input" name="eps" id="eps" type="checkbox" size="10px" value="" id="flexCheckDefault">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <select class="form-select" name="Epstype" id="Epstype" aria-label="" required
                                                oninput="setCustomValidity('')">
                                                    <option selected value="">Seleccione tipo</option>
                                                    <option value='1'>Contribuitivo</option>
                                                    <option value="2">Subsidiado</option>
                                                </Select>
                                            </div> 
                                            <div class="col-sm-3">
                                                <label for="contract" class="form-label"> Contrato </label>
                                                <select class="form-select" name="contract" id="contract" aria-label="" required
                                                oninput="setCustomValidity('')">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <select class="form-select" name="Ips" id="Ips" aria-label="" required
                                                oninput="setCustomValidity('')">
                                    ...
                                    <div class="tab-pane fade p-2" id="nav-legal" role="tabpanel" aria-labelledby="nav-legal-tab">
                                        ...
                                        <div class="container mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <label for="legalname" class="form-label"> Nombre </label>
                                                    <input type="text" class="form-control" name="legalname" id="legalname" placeholder="Nombre responsable">
                                                </div> 

                                                <div class="col-sm-2">
                                                    <label for="legaltypedoc" class="form-label">Tipo Documento</label>
                                                    <select class="form-select" name="legaltypedoc" id = "legaltypedoc" aria-label="legal document type" required
                                                    oninput="setCustomValidity('')">
                                                    {{-- lv --}}
                                                    @foreach ( $typeDocs as $typeDoc )
                                                ...
                                                <div class="col-sm-3">
                                                    <label for="legaldoc" class="form-label"> Numero Identificación </label>
                                                    <input type="text" class="form-control" name="legaldoc" id="legaldoc" placeholder="No identificación">
                                                </div> 

                                                <div class="col-sm-3">
                                                    <label for="legaltypedoc" class="form-label">Relación / Parentesco</label>
                                                    <select class="form-select" name="legaltypedoc" id = "legaltypedoc" aria-label="legal document type" required
                                                    oninput="setCustomValidity('')">
