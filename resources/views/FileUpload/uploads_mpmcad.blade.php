...
>
    ...
    <div class="container-fluid"> 
        <div class="col-6 col-sm-12 text-center">
            <img src="img/CAD.jpg" alt="CAD" class="h-32 w-32 object-cover mb-2" height="500px">   
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="col-12 col-sm-12 border-5 text-dark">
                <div class="col-1 col-sm-12 text-center">
                    <h1 class="text-white" style="background-color:#0a4275">CAD</h1>
                </div>
                <div class="card flex-md-row mb-3 shadow-md h-md-250">
                    <p class="text-justify ">
                        Es una unidad que brinda atención integral a pacientes con trastornos mentales, sin requerir hospitalización completa. 
                        ...
                        rehabilitación y reintegración social del paciente, en un entorno menos restrictivo que la hospitalización.
                        </p>
                </div>
