            ...
            @if (!isset($hiddenButtons))
                <td>
                    <div class="row col-sm-12 justify-content-around">
                        <button class="btn btn-primary btn-md col-sm-4 text-white"
                            onclick="location.href = '{{ route($module . 'Show', $row->id) }}';">
                            <i class="bi bi-eye"></i>
                        </button>
                        <button class="btn btn-warning btn-md col-sm-4 text-white"
                            onclick="location.href = '{{ route($module . 'Edit', $row->id) }}';">
                            <i class="bi bi-pen-fill" title="modificar"></i>
                        </button>
                        <button class="btn btn-danger btn-md col-sm-3" data-bs-toggle="modal" 
