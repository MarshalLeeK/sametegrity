    ...
    <nav class="navbar navbar-expand-sm" id="navbar">
        <div class="container-fluid bg-white">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    @if ($route != 'login' && $route != 'index' && $view != 'C' && $view != 'M')
                        ...
                        @if ($view != 'L')
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="{{ route($module) }}"
                        ...
                        @if ($view != 'C' && $view != 'M')
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="{{ route($module . 'Create') }}"
            ...
            <div class="row mx-1 p-1">
                <a class="form-group nav-link col-2" type="submit" aria-current="page" href="{{ route('signOut') }}"
                    title="Cerrar Sesión">
